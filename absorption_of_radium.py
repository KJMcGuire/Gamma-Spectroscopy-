...
NIST_energies = [ .200, .300, .400, .500, .600, .800, 1.000, 1.250]
NIST_coeff  = [ .9985, .4031, .2323, .1614, .1248, .08870, .07102, .05876]

NIST_params, NIST_covars = curve_fit(exponential, NIST_energies, NIST_coeff, p0 = [100000., .000001]) #bounds = [ 200, [1500., 1000] ]

print NIST_params

x2 = np.linspace(0, 2, 1011)

plt.figure(figsize=(10,7))
plt.plot(x2, exponential(x2, *NIST_params), label = "Fit curve ($\widetilde{\chi^2}$ = )")
